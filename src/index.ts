...
export async function companionJs() {
  ...
  await Write("./result/floris_companion.txt", Stringify(safeSubs));

  {
...

    {
      ...
      await Write("./result/safe_subs_lord_sub.txt", stringify2(safeSubsLordSub));
    }

    {
      ...
      await Write("./result/final_result.txt", stringify2(finalResult));
    }
  }
}
